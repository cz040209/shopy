...
import { ArrowUpRight, Banknote, Check, CheckCircle2, Clock3, CreditCard, LoaderCircle, LockKeyhole, Plus, ReceiptText, ShieldCheck, WalletCards } from "lucide-react";
...
const paymentSources = [
  { label: "FPX Online Banking", mark: "FPX", className: "fpx" },
  { label: "TNG eWallet", mark: "TNG", className: "tng" },
  { label: "DuitNow Transfer", mark: "DuitNow", className: "duitnow" },
  { label: "Visa ending 4242", mark: "VISA", className: "visa" },
] as const;
